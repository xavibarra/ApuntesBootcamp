<template>
  <div class="app">
    <Tweet v-for="(tweetArr,index) in tweets" :key="index" :tweet="tweetArr" />
  </div>
</template>
...
<script setup>
  ...
  const tweets = ref([
    ...
    },
    {
      user: {
        name: "Xavi",
        image: "https://media-exp1.licdn.com/dms/image/C4E03AQE0zn66WXh2tA/profile-displayphoto-shrink_800_800/0/1658851840530?e=2147483647&v=beta&t=_9K1rLzhdQA2Kfo7YxzuOPFxDqJnnl-TyDY0UEOzOYI",
        handle: "xavibarra",
      },
      timestamp: "4h ago",
      message: "Hola sóc el Xavi",
    }
]);
</script>
