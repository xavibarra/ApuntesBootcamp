...
switch (switchExample) {
    ...
    case 2:
        ...
        break;
    default:
        switchExample = "Not found";
        break;
}
console.log(`The value is ${switchExample}`);
...
let countryOfOrigin = prompt("What country? ").toLowerCase(); //usamos el lowercase por si el usuario introduce el pais con mayuscula
switch (countryOfOrigin) {
    case "venezuela":
    case "argentina":
    case "brasil":
        alert(`${countryOfOrigin} is in South America`);
        break;
    case "spain":
    case "portugal":
    case "italy":
