...
const buttonCol = document.querySelector("#exercise");
const toggleExercise = () => document.querySelector(".exercise").classList.toggle("exercisered");
buttonCol.addEventListener("click", toggleExercise);
